...
empty= Label(root, text="Keylogger Project", font='Verdena  11 bold',
             relief="groove", bg="#F0F0F0", fg="#333333", width=15,
             height=5).grid(row=3,column=1, columnspan=3, padx=10, pady=10)
empty= Label(root, text=" ").grid(row=4,column=0)
empty= Label(root, text=" ").grid(row=5,column=0)
Button(root, text="Start Keylogger", command=butaction, bg="#4CAF50",
       fg="white", relief="raised", bd=2).grid(row=6,column=1, columnspan=3, pady=10)    
root.mainloop()
